...
const PlacementDrives: React.FC = () => {
  ...
  const companies = [
    {
      ...
      previousYearPapers: [
        {
          year: 2024,
          link: "https://placement.freshersworld.com/flipkart-placement-papers/placement-paper/3313776",
        },
        {
          year: 2023,
          link: "https://placement.freshersworld.com/flipkart-placement-papers/aptitude-numerical/33131281",
        },
      ],
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row">
      <div className="max-w-7xl mx-auto w-full lg:w-2/3">
      ...
      <div className="w-full lg:w-1/3 lg:ml-6">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden p-6 mb-6">
          ...
          {drives
            ...
            .map((drive) => (
              <div key={drive._id} className="mb-4">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden p-6">
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Ongoing Drives</h2>
          {drives

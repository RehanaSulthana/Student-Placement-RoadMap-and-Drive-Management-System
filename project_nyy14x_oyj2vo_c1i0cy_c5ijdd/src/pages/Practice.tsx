...
//     { id: 'linked-lists', name: 'Linked Lists', icon: <Code className="h-5 w-5" /> },
...
//     { id: 'dynamic-programming', name: 'Dynamic Programming', icon: <Code className="h-5 w-5" /> },
//     { id: 'hash-tables', name: 'Hash Tables', icon: <Code className="h-5 w-5" /> },
//   ];
